...
//check how many blocks flipped
function checkWin(){
    let allRemainingBlocks=allBlocks.filter(flippeBlock=>flippeBlock.classList.contains('has-match'));
    if (allRemainingBlocks.length===allBlocks.length){
        playWinEff();
    }
}
